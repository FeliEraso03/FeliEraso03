...
class FelipeEraso:
    ...
    def __init__(self):
        ...
        self.traits = [
            "Responsible", "Analytical", "Problem-solver",
    ...
    def code(self):     return "Turning coffee into scalable solutions."
    def debug(self):    return "Fixing bugs during development."
    def deploy(self):   return "Deploying applications to production."
    def learn(self, topic): return f"Currently learning about {topic}."
    def automate(self): return "Automating repetitive processes."
...
<table>
<tr>
<td width="33%" align="center"><img width="22" height="22" src="assets/icons/book.svg"/><br/><b>Learning</b><br/>Distributed systems & microservices patterns</td>
<td width="33%" align="center"><img width="22" height="22" src="assets/icons/tool.svg"/><br/><b>Building</b><br/><code>MurallaGraph</code> — routing engine for Cartagena's Historic Center</td>
<td width="33%" align="center"><img width="22" height="22" src="assets/icons/target.svg"/><br/><b>Goal 2026</b><br/>Ship a production-grade backend project end-to-end</td>
</tr>
</table>
...
### <img width="18" height="18" src="assets/icons/mappin.svg"/> MurallaGraph
...
### <img width="18" height="18" src="assets/icons/image.svg"/> REST API — Image & User Management
...
### <img width="18" height="18" src="assets/icons/rocket.svg"/> OnBoard
...
### <img width="18" height="18" src="assets/icons/gear.svg"/> Automation Scripts
...
<img width="20" height="20" align="left" src="assets/icons/cap.svg"/>&nbsp;**Systems Engineering** — Universidad de Cartagena (2022 – Present)

<br/><br/>

| | Certification | Year |
|---|---|---|
| <img width="18" height="18" src="assets/icons/award.svg" /> | AWS Academy Graduate — Cloud Developing | 2025 |
| <img width="18" height="18" src="assets/icons/award.svg" /> | Data Analysis with Python — IBM | 2024 |
| <img width="18" height="18" src="assets/icons/award.svg" /> | Data Science Tools — IBM | 2024 |
| <img width="18" height="18" src="assets/icons/award.svg" /> | Data Visualization with Python — IBM | 2024 |
| <img width="18" height="18" src="assets/icons/award.svg" /> | Software Development Diploma — UdeA (Misión TIC) | 2022 |
| <img width="18" height="18" src="assets/icons/award.svg" /> | Python Programming Fundamentals Diploma — UdeA (Misión TIC) | 2022 |

## `languages`

<img width="18" height="18" align="left" src="assets/icons/globe.svg"/>&nbsp;**Spanish** — Native
![](https://progress-bar.xyz/100?title=&width=220&color=FF00CC&suffix=%20&scale=100)

<img width="18" height="18" align="left" src="assets/icons/globe.svg"/>&nbsp;**English** — Intermediate
...
<img width="18" height="18" src="assets/icons/moon.svg"/>
